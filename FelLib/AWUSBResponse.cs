namespace com.clusterrr.FelLib {
	internal class AWUSBResponse {
		...
		public AWUSBResponse(byte[] data) {
			...
			Tag = (uint) (data[4] | (data[5] * 0x100) | (data[6] * 0x10000) | (data[7] * 0x1000000));
			Residue = (uint) (data[8] | (data[9] * 0x100) | (data[10] * 0x10000) | (data[11] * 0x1000000));
			CswStatus = data[12];
		}
