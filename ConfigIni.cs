...
namespace com.clusterrr.hakchi_gui {
	public class ConfigIni {
		...
		public static bool CustomFlashedNes;
		public static bool CustomFlashedFamicom;
		public static bool CustomFlashedSnes;
		public static bool CustomFlashedSuperFamicom;
		...
		public static byte AntiArmetLevel;
		...
		public static bool AutofireHackNes;
		public static bool AutofireHackSnes;
		public static bool AutofireXYHack;
		public static bool FcStart;
		public static bool ResetHackNes = true;
		public static bool ResetHackSnes = true;

		public static uint ResetCombinationNes =
			(uint) (SelectNesButtonsForm.NesButtons.Down | SelectNesButtonsForm.NesButtons.Select);

		public static uint ResetCombinationSnes = (uint) (SelectSnesButtonsForm.SnesButtons.L |
		                                                  SelectSnesButtonsForm.SnesButtons.R |
		                                                  SelectSnesButtonsForm.SnesButtons.Select |
		                                                  SelectSnesButtonsForm.SnesButtons.Start);
		...
		public static bool FtpServer;
		public static bool TelnetServer;
		...
		public static uint ResetCombination {
			...
			set {
				switch (ConsoleType) {
					...
					case MainForm.ConsoleType.NES:
					case MainForm.ConsoleType.Famicom:
						ResetCombinationNes = value;
						break;
					case MainForm.ConsoleType.SNES:
					case MainForm.ConsoleType.SuperFamicom:
						ResetCombinationSnes = value;
						break;
				}
			}
		}
		...
		public static Dictionary<string, string> GetConfigDictionary() {
			...
			config["clovercon_home_combination"] = ResetHack ? string.Format("0x{0:X4}", ResetCombination) : "0xFFFF";
			config["clovercon_autofire"] = AutofireHack ? "1" : "0";
			config["clovercon_autofire_xy"] =
				AutofireXYHack && (ConsoleType == MainForm.ConsoleType.NES || ConsoleType == MainForm.ConsoleType.Famicom)
					? "1"
					: "0";
			config["clovercon_fc_start"] = FcStart && ConsoleType == MainForm.ConsoleType.Famicom ? "1" : "0";
			config["fontfix_enabled"] = UseFont ? "y" : "n";
			config["disable_armet"] =
				AntiArmetLevel > 0 && (ConsoleType == MainForm.ConsoleType.NES || ConsoleType == MainForm.ConsoleType.Famicom)
					? "y"
					: "n";
			if (ConsoleType == MainForm.ConsoleType.NES || ConsoleType == MainForm.ConsoleType.Famicom)
				config["nes_extra_args"] = ExtraCommandLineArguments;
			if (ConsoleType == MainForm.ConsoleType.SNES || ConsoleType == MainForm.ConsoleType.SuperFamicom)
				config["snes_extra_args"] = ExtraCommandLineArguments;
			return config;
		}
	}
}